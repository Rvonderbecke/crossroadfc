					...
					<div className='tkd-content infoBox'>
						...
						<div className='self-awareness'>
							...
							<p>
								...
								processing skills introduced with self-control. These lessons
								are designed to increase ones awareness of the power they hold
								to influence their environment through self evident
								accomplishments while introducing steps of true confidence
								development.{' '}
							</p>
							<div className='belts'>
								<div className='belt'>
						...
						<div className='strength'>
							...
							<p>
								...
								standing on the principles established in the previous courses
								advanced practitioners start developing their own concrete sense
								of self. Introducing lessons to master over a life time,
								possessing the ability to lead with morally sound character and
								free from adverse influence that surrounds marks the traits of a
								student who has the endurance and commitment to complete this
								course.{' '}
							</p>
							<div className='belts'>
								<div className='belt'>
						...
						<div className='black-belt'>
							...
							<p>
								...
								classes are not for bragging rights but rather are designed to
								break down every detail and rebuild your skills to a new level
								that is only limited by ones own perception of what is possible.
								Completion of these classes earns you privileges only available
								to those who endure where others have failed.{' '}
							</p>
							<div className='belts'>
								<div className='belt'>
...
const Wrapper = styled.section`
	...
	.content {
		...
		.black-belt {
            ...
            .lightBlue {
				background-color: var(--belt-lightBlue);
			}
			.darkBlue {
				background-color: var(--belt-darkBlue);
			}
			.brown {
