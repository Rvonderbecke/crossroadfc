...
const HomePage = () => {
    ...
    return (
      ...
      <div className="homePageContainer">
              ...
              <img src={`images/ad${currentCount}.jpg`} alt="Current Promotions" onClick={() => {
                  if (currentCount >= ads) {
                      setCurrentCount(0);
                      return
                  };
              ...
              <div className="dots"><span id='0'className="dot"></span><span id='1'className="dot"></span><span id='2'className="dot"></span></div>
          </Row>
          <Row>
              ...
              <div className="homeLinks">
                  ...
                  <Link to='/'><button className="btnHome homeBtnAbout">About Us</button></Link>
              </div>
          </Row>
            </div>
            </HomePageWrapper>
